    ...
    public void onClick(View v) {
        switch (v.getId()) {
                    ...
                    public void run() {
                        ...
                        myNews.delete(new UpdateListener() {
                            ...
                            public void done(BmobException e) {
                                if (e == null) {
                                    ToastUtils.showToast(ShowNewsActivity.this, "删除成功");
                                    ShowNewsActivity.this.finish();
                                } else {
                                    ToastUtils.showToast(ShowNewsActivity.this, "删除失败");
                                }
                            }
                        });
                    }
            ...
            case R.id.details_edit:
                //跳转到编辑页面
                Intent it = new Intent(ShowNewsActivity.this, AddNewsActivity.class);
